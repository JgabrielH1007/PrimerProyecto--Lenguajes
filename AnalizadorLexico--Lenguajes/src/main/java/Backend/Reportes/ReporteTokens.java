...
public class ReporteTokens extends JFrame {
    ...
    public ReporteTokens(List<TokensHTML> listaTokensHtml, List<TokensCSS> listaTokensCss, List<TokensJS> listaTokensJS) {
    ...
    private void exportarTablaAHTML() {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("reporte_tokens.html"))) {
